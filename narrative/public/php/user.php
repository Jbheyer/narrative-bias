                    ...
                    success: function(data, textStatus, xhr) {
                        ...
                        if(data.indexOf('success') >= 0) { // if true (1)
                            setTimeout(function(){// wait for 5 secs(2)
                                location.href = '../survey/pre_survey.html'; // then reload the page.(3)
                            }, 100);
                        }
                        else{
...
<body>
 ...
 <?php
        ...
        if($_SESSION['error']=='user') {
          ?><br><span class="instructions" style="color: red">The Mturk ID entered is invalid or already exists (have you taken this study before?)</span><?php
          }
        }
?>
    <p><div class="instructions" style="margin-top: 30px">
      ...
      <p><form onsubmit="return false;">
        <input style="font-size: 15px; width: 250px" type="text" id="mturk" placeholder="your MTurk ID">
      </form>
